...
class HalfTest extends TestCase
{
    ...
    {
        $this->assertEquals($expVal, (Half::set($testVal))->exist());
    }
    ...
    {
        $this->assertEquals($expVal, (Half::set($testVal))->notExist());
    }
    ...
    {
        $this->assertEquals($expVal, (Half::set($testVal))->only());
    }
    ...
    {
        $this->assertEquals($expVal, (Half::set($testVal))->notOnly());
    }
}
