...
use Selen\Verify\Str\Radixes\Radix5;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix5
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix5
 *
 * @see \Selen\Verify\Str\Radixes\Radix5
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix5
 *
 * @internal
 */
class Radix5Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 5進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '01234'],

            'pattern_74' => ['expVal' => false, 'testVal' => '012345'],
            'pattern_75' => ['expVal' => false, 'testVal' => '01234a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '01234A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix5::verify($testVal));
    }
}
