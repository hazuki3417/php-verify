...
use Selen\Verify\Str\Radixes\Radix10;
 ...
 * @internal
 */
class Radix10Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 10進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '0123456789'],

            'pattern_74' => ['expVal' => false, 'testVal' => '0123456789A'],
            'pattern_75' => ['expVal' => false, 'testVal' => '0123456789a'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix10::verify($testVal));
    }
}
