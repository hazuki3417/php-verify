...
use Selen\Verify\Str\Radixes\Radix9;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix9
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix9
 *
 * @see \Selen\Verify\Str\Radixes\Radix9
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix9
 *
 * @internal
 */
class Radix9Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 9進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '012345678'],

            'pattern_74' => ['expVal' => false, 'testVal' => '0123456789'],
            'pattern_75' => ['expVal' => false, 'testVal' => '012345678a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '012345678A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix9::verify($testVal));
    }
}
