...
use Selen\Verify\Str\Radixes\Radix2;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix2
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix2
 *
 * @see \Selen\Verify\Str\Radixes\Radix2
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix2
 *
 * @internal
 */
class Radix2Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 2進数で使えない文字（数字）
            'pattern_03' => ['expVal' => false, 'testVal' => '2'],
            'pattern_04' => ['expVal' => false, 'testVal' => '3'],
            'pattern_05' => ['expVal' => false, 'testVal' => '4'],
            'pattern_06' => ['expVal' => false, 'testVal' => '5'],
            'pattern_07' => ['expVal' => false, 'testVal' => '6'],
            'pattern_08' => ['expVal' => false, 'testVal' => '7'],
            'pattern_09' => ['expVal' => false, 'testVal' => '8'],
            'pattern_10' => ['expVal' => false, 'testVal' => '9'],

            // 2進数で使えない文字（アルファベット小文字）
            ...
            // 2進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '01'],

            'pattern_74' => ['expVal' => false, 'testVal' => '012'],
            'pattern_75' => ['expVal' => false, 'testVal' => '01a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '01A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix2::verify($testVal));
    }
}
