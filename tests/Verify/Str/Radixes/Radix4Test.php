...
use Selen\Verify\Str\Radixes\Radix4;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix4
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix4
 *
 * @see \Selen\Verify\Str\Radixes\Radix4
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix4
 *
 * @internal
 */
class Radix4Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 4進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '0123'],

            'pattern_74' => ['expVal' => false, 'testVal' => '01234'],
            'pattern_75' => ['expVal' => false, 'testVal' => '0123a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '0123A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix4::verify($testVal));
    }
}
