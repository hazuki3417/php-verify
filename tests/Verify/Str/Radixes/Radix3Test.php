...
class Radix3Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            'pattern_73' => ['expVal' => true, 'testVal' => '012'],

            'pattern_74' => ['expVal' => false, 'testVal' => '0123'],
            'pattern_75' => ['expVal' => false, 'testVal' => '012a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '012A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix3::verify($testVal));
    }
}
