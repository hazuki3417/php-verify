...
use Selen\Verify\Str\Radixes\Radix6;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix6
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix6
 *
 * @see \Selen\Verify\Str\Radixes\Radix6
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix6
 *
 * @internal
 */
class Radix6Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 6進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '012345'],

            'pattern_74' => ['expVal' => false, 'testVal' => '0123456'],
            'pattern_75' => ['expVal' => false, 'testVal' => '012345a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '012345A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix6::verify($testVal));
    }
}
