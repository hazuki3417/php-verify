...
use Selen\Verify\Str\Radixes\Radix7;

/**
 * @coversDefaultClass \Selen\Verify\Str\Radixes\Radix7
 *
 * @group Selen/Verify/Str/Radixes
 * @group Selen/Verify/Str/Radixes/Radix7
 *
 * @see \Selen\Verify\Str\Radixes\Radix7
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/Verify/Str/Radixes/Radix7
 *
 * @internal
 */
class Radix7Test extends TestCase
{
    public function inspectionPatternVerify()
    {
        return [
            ...
            // 7進数形式の文字列をチェックできるかテスト
            'pattern_73' => ['expVal' => true, 'testVal' => '0123456'],

            'pattern_74' => ['expVal' => false, 'testVal' => '01234567'],
            'pattern_75' => ['expVal' => false, 'testVal' => '0123456a'],
            'pattern_76' => ['expVal' => false, 'testVal' => '0123456A'],
        ];
    }
    ...
    {
        $this->assertEquals($expVal, Radix7::verify($testVal));
    }
}
